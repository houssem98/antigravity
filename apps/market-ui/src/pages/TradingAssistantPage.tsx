...
export default function TradingAssistantPage() {
  ...
  const renderTabContent = () => {
    switch(activeTab) {
      case 'Markets': return <Markets onAssetSelect={(a) => { setCurrentAsset(a); setActiveTab('Chart'); }} />;
      case 'News': return <NewsTab asset={currentAsset} />;
      case 'Yield': return <YieldTab asset={currentAsset} />;
      case 'Holders': return <HoldersTab asset={currentAsset} />;
      case 'About': return <AboutTab asset={currentAsset} />;
      case 'Chart':
      default:
        return (
